  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="flex flex-col md:w-[65%] w-[85%] items-center">
        ...
        <h1 className="hidden">
          Top Destination Wedding Venues Open air Near You
        </h1>
        ...
        canopy of stars. Dremable.com unlocks the magic of Kolkata&lsquo;s
        wedding resorts and open-air destinations, creating a wedding experience
        that&lsquo;s both breathtaking and unforgettable.
