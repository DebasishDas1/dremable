  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative flex md:hidden">
        <Image
          src={
            "https://images.pexels.com/photos/6530614/pexels-photo-6530614.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          }
          alt="landing page"
          width={1500}
          height={500}
      ...
      <div className="relative hidden md:flex ">
        <Image
          src={
            "https://images.pexels.com/photos/6530730/pexels-photo-6530730.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          }
          alt="landing page"
          width={1500}
          height={500}
        ...
        <div className="absolute top-10 text-8xl flex flex-col items-center">
          ...
          <div className="w-[80%] text-lg pb-5">
            {" "}
            Your dream wedding begins here. Expression of Dreams specializes in
            turning your love story into a breathtaking celebration, blending
            elegance, imagination, and heartfelt dedication
