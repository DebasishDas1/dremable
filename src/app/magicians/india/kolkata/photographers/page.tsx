  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="flex flex-col md:w-[65%] w-[85%] items-center">
        ...
        Looking for best wedding photographers near you to capture the magic of
        your Dream wedding? Your search ends here! Dremable connects you with
        Kolkata&apos;s best wedding photographers, specializing in various
        styles, including Bengali wedding photography.
        <br />
        <br />
