  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="flex flex-col md:w-[65%] w-[85%] items-center">
        ...
        that enhances your natural beauty plays a crucial role in capturing that
        feeling. At Dremable, we connect you with Kolkata&apos;s best bridal
        makeup artists, ensuring you radiate confidence and glow on your special
        day. From traditional Bengali wedding styles to modern glamour, find
        your perfect match and experience artistry that reflects your unique
        vision.
        ...
        artists and find your perfect match! With Dremable by your side, you can
        step into your wedding day feeling confident, radiant, and undeniably
        beautiful. Remember, your makeup should tell your story – let Dremable
        help you write it on your canvas of beauty
      </div>
    </div>
  );
};
