    ...
    return (
        <div className='flex flex-col items-center'>
            <div className='flex flex-col md:w-[65%] w-[85%] items-center'>
                ...
                <div className='pb-2'>
                    The seed of EOD was sown, not amidst champagne wishes and confetti bursts, but in
                ...
                <div className='pb-2'>
                    Thus, EOD was born. Not just an aggregator, but a haven for discerning couples, a
