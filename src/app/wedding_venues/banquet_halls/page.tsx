  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="flex flex-col md:w-[65%] w-[85%] items-center">
        ...
        Dreamable.com, your Kolkata wedding venue concierge, unlocks a treasure
        ...
        an intimate ceremony under the gentle embrace of nature, Dreamable.com
        ...
        Dreamable.com goes beyond showcasing stunning venues. We empower you to
        plan your dream wedding with ease and confidence:
        <PageBnifitOptions banifits={effortlessPlanning} />
        <div className="md:text-3xl text-2xl font-bold md:p-12 py-8">
          The Dreamable Advantage: Transforming Dreams into Reality
        </div>
        Dreamable.com sets itself apart by offering a multitude of benefits that go beyond simply showcasing wedding venues:
